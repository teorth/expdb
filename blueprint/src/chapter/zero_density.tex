...
\begin{table}[ht]
    ...
    \hline
    $\frac{6}{5\sigma - 1}$ & $\frac{13}{17} \le \sigma < \frac{17}{22} = 0.7722\ldots$ & Theorem \ref{further_ivic_zero} \\
    \hline
    $\frac{2}{9\sigma - 6}$ & $\frac{17}{22} \le \sigma < \frac{38}{49} = 0.7755\ldots$ & Theorem \ref{bourgain-density-improved} \\
    \hline
    $\frac{9}{8(2\sigma-1)}$ & $\frac{38}{49} \le \sigma < \frac{4}{5} = 0.8\ldots$ & Theorem \ref{bourgain-density-improved} \\
    \hline
    $\frac{3}{2\sigma}$ & $\frac{4}{5} \le \sigma < \frac{7}{8} = 0.875$ & Theorem \ref{further_ivic_zero} \\
    \hline
