...
\begin{theorem}[Pintz zero density theorem with subdivision]\label{pintz-density-subdiv}\uses{zero-def} If $k \geq 4$, $\ell \geq 3$ are integers and $\sigma = 1-\eta$ is such that
