...
\begin{theorem}[Improved Bourgain density hypothesis bound] For $38/49 \leq \sigma \leq 4/5$, one has $\A(\sigma) \leq \frac{9}{8(2\sigma-1)}$.
\end{theorem}

\begin{proof}  We apply Corollary \ref{zer-large-cor3} with $\tau_0 := \frac{8(2\sigma-1)}{3}$.  For future reference we note that
