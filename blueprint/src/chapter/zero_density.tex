...
\begin{table}[ht]
    ...
    \hline
$\dfrac{11}{48\sigma - 36}$ & $\dfrac{31}{34} \le \sigma < \dfrac{14}{15} = 0.9333\ldots$ & Corollary \ref{bourgain-zero-density-optimized} \\
\hline
...
\hline
    $\dfrac{3}{24\sigma - 20}$ & $\dfrac{23}{24} < \sigma < \dfrac{60725033}{62460603} = 0.9722\ldots$ & Theorem \ref{pintz-density} \\
    \hline
