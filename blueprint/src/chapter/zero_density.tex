...
The arguments can be pushed to some $\sigma$ below $17/22$, but in that range the estimate in Theorem \ref{further-ivic-zero} becomes superior, so we do not pursue this further.
...
We first consider the case when $17/22 \leq \sigma \leq 4/5$, so that $\tau_0 = 8(2\sigma-1)/3$.
...
However, this result is now superseded by Theorem \ref{bourgain-density-improved}.
...
\begin{table}[ht]
    ...
    \hline
    $\dfrac{9}{8\sigma - 2}$ & $\dfrac{19}{25} \leq \sigma < \dfrac{127}{167} = 0.7604\ldots$ & Theorem \ref{further_ivic_zero}\\
    \hline
    $\dfrac{15}{13\sigma - 3}$ & $\dfrac{127}{167} \leq \sigma < \dfrac{13}{17} = 0.7647\ldots$ & Theorem \ref{further_ivic_zero}\\
    \hline
    $\dfrac{6}{5\sigma - 1}$ & $\dfrac{13}{17} \leq \sigma < \dfrac{17}{22} = 0.7727\ldots$ & Theorem \ref{further_ivic_zero}\\
    \hline
    $\dfrac{2}{9\sigma - 6}$ & $\dfrac{17}{22} \leq \sigma < \dfrac{41}{53} = 0.7735\ldots$ & Theorem \ref{bourgain-density-improved}\\
    \hline
    $\dfrac{9}{7\sigma - 1}$ & $\dfrac{41}{53} \leq \sigma < \dfrac{7}{9} = 0.7777\ldots$ & Theorem \ref{further_ivic_zero}\\
    \hline
    ...
    \hline
    $\dfrac{3}{2\sigma}$ & $\dfrac{4}{5} \le \sigma < \dfrac{7}{8} = 0.875$ & Theorem \ref{further_ivic_zero} \\
    \hline
    ...
    \hline
    $\dfrac{3}{10\sigma - 7}$ & $\dfrac{9}{10} < \sigma \le \dfrac{47}{50} = 0.94$ & Theorem \ref{hb-density2}\\
    \hline
    $\dfrac{4}{30\sigma - 25}$ & $\dfrac{47}{50} < \sigma \le \dfrac{23}{24} = 0.9583\ldots$ & Corollary \ref{bourgain-zero-density} \\
    \hline
    $\dfrac{3}{24\sigma - 20}$ & $\dfrac{23}{24} < \sigma < \dfrac{39}{40} = 0.975$ & Theorem \ref{pintz-density} \\
    \hline
    ...
    \hline
    $\dfrac{3}{n(1 - 2(n - 1)(1 - \sigma))}$ & \begin{tabular}{@{}c@{}}$1 - \frac{1}{2n(n - 1)} \le \sigma < 1 - \frac{1}{2n(n + 1)}$\\(for integer $n \ge 6$)\end{tabular} & Theorem \ref{pintz-density} \\
    \hline
    \end{tabular}
