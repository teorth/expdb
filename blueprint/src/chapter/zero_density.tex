...
\begin{theorem}[Chen-Debruyne-Vidas density theorem]\cite{chen_debruyne_vindas_density_2024}  For any $279/314 \leq \sigma \leq 17/18$, one has $\A(\sigma) \leq \frac{24}{30\sigma-11}$.
\end{theorem}
...
\begin{table}[ht]
    ...
    \centering
    \caption{Upper bounds on $\A(\sigma)$}
    \begin{tabular}{|c|c|c|}
    \hline
    ...
    \hline
    $\frac{9}{7\sigma - 1}$ & $\frac{11}{14} < \sigma < \frac{3831}{4791} = 0.7996\ldots$ & Theorem \ref{hb-density} \\
    \hline
    ...
    \hline
    $\frac{24}{30\sigma - 11}$ & $\frac{279}{314} \le \sigma < \frac{155}{174} = 0.8908\ldots$ & Chen--Debruyne--Vindas \cite{chen_debruyne_vindas_density_2024}  \\
    \hline
...
{\bf TODO: record historical zero density estimates, as well as log-free zero density estimates for $\sigma$ near $1/2$ or near $1$.}
