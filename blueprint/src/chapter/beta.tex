...
\begin{lemma}\uses{beta-def}  In Definition \ref{beta-def}, one can take the interval $I$ to be $[N,2N]$.
\end{lemma}
...
\begin{theorem}[Sargos bound]\uses{beta-def}  For any $\alpha > 0$ one has
