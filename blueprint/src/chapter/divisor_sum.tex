...
\begin{theorem}\label{ivic-alpha-1989}\cite{ivic_ouellet_1989}\uses{divisor-def} One has
\begin{align*}
...
\begin{lemma}[van der Corput first bound on $\alpha_2$]\label{vdc-alpha-1}\uses{divisor-def}
