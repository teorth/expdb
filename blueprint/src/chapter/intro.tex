...
\begin{itemize}
    ...
    \item Links to an external site.Character sum bounds (such as the Polya-Vinogradov and Burgess bounds) and the least quadratic residue problem.
    ...
    \item The Gauss circle problemLinks to an external site. and its generalizations.
