...
For $103/136 \le \sigma \le 31/40$, one has
\[
...
\begin{proof}
Fix $103/136 \le \sigma \le 31/40$ and take $\tau_0 = 2$. It suffices to show that
\[
...
Meanwhile, by Theorem \ref{guth-maynard-lvt}, one has 
\[
\rho/k \le \max(18/5 - 4\sigma, 12/5 - 4\sigma + \tau') = \begin{cases}
18/5 - 4\sigma,& \tau' \le 6/5\\
12/5 - 4\sigma + \tau',&\tau' > 6/5
...
\[
\rho \le \max(2 - 2\sigma,  19/5 - 29\sigma/5 + \tau, 60 - 80\sigma + \tau).
\]
In particular, for $\sigma \ge 281/371$, this reduces to 
\[
\rho \le \max(2 - 2\sigma, 19/5 - 29\sigma/5 + \tau)
\]
and for $\sigma < 281/371$ this reduces to 
\[
\rho \le \max(2 - 2\sigma, 60 - 80\sigma + \tau).
\]
In the former case, we use 
\begin{equation}\label{ze-bound5-rho-bound}
\rho/k \le \begin{cases}
2 - 2\sigma,& 1 \le \tau' < (19\sigma - 9)/5,\\
19/5 - 29\sigma/5 + \tau',& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5,\\
...
\end{cases}
\end{equation}
By Lemma \ref{power-energy}, $(\sigma, \tau', \rho', \rho^*/k, s') \in \Energy$ for some $\rho' \le \rho/k$ and $s' \le s/k$. Applying Theorem \ref{hbt}, and noting that $\rho/k + 1 \ge 2\rho/k$ since $\rho/k \le 1$ by \eqref{ze-bound3-rhok}, 
\[
...
If $\rho/k + 1 \ge 5\rho/(4k) + \tau'/2$, then 
    \[
    \frac{\rho^*}{k} \le \frac{3}{2} - 2\sigma + \frac{\rho}{2k} + \frac{1}{2}\max(\frac{\rho^*}{k}+1, \frac{4\rho}{k}, \frac{3\rho^*}{4k} +\frac{\rho}{k}+\frac{\tau'}{2}).
    \]
Solving for $\rho^*/k$ gives
\[
\rho^*/k \le \max(4 - 4\sigma + \frac{\rho}{k}, \frac{3 - 4\sigma + 5\rho/k}{2}, \frac{2}{5}(6 - 8\sigma + \tau' + \frac{4\rho}{k})).
\]
In light of \eqref{ze-bound5-rho-bound}, one obtains
\begin{align*}
\frac{3 - 4\sigma + 5\rho/k}{2} &\le \begin{cases}
13/2 - 7\sigma,& 1 \le \tau' < (19\sigma - 9)/5,\\
11 - 33\sigma/2 + 5\tau'/2,& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5,\\
21/2 - 12\sigma,& (9\sigma - 1)/5 \le \tau' < 6/5,\\
15/2 - 12\sigma + 5\tau'/2,& 6/5 \le \tau' < 2\sigma - 2/5 + 2(1 - \sigma)/k,\\
13/2 - 7\sigma + 5(1-\sigma)/k,& 2\sigma - 2/5 + 2(1 - \sigma)/k \le \tau' \le (k + 1)/k.
\end{cases}
\end{align*}
One may verify that the RHS is bounded by $\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'$ (with equality at $\tau' = 2\sigma - 2/5 + 2(1 - \sigma)/k$ when $k = 2$). Similarly, 
\[
\frac{2}{5}(6 - 8\sigma + \tau' + \frac{4\rho}{k}) \le \begin{cases}
2(14 - 16\sigma)/5 + 2\tau'/5,& 1 \le \tau' < (19\sigma - 9)/5,\\
4(53 - 78\sigma)/25 + 2\tau',& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5,\\
2(102 - 120\sigma)/25 + 2\tau'/5,& (9\sigma - 1)/5 \le \tau' < 6/5\\
2(78 - 120\sigma)/25 + 2\tau',& 6/5 \le \tau' < 2\sigma - 2/5 + 2(1 - \sigma)/k\\
(16(1 - \sigma)/k + (28 - 32\sigma))/5 + 2\tau'/5,& 2\sigma - 2/5 + 2(1 - \sigma)/k \le \tau' \le (k + 1)/k
\end{cases}.
\]
One may verify that the RHS is bounded by $\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'$ (with room to spare). Therefore, one has 
\[
\frac{\rho^*}{k} \le \max\left(4 - 4\sigma + \frac{\rho}{k}, \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'\right).
\]
Now assume that $\rho/k + 1 \le 5\rho/(4k) + \tau'/2$, so that
\[
\rho^*/k \leq 1-2\sigma + \frac{5\rho}{8k} + \frac{\tau'}{4} + \frac{1}{2}\max(\frac{\rho^*}{k}+1, \frac{4\rho}{k}, \frac{3}{4}\frac{\rho^*}{k} + \frac{\rho}{k}+\frac{\tau'}{2}).
\]
Solving for $\rho^*/k$ gives 
...
\rho^*/k \le \max(3 - 4\sigma + \frac{\tau'}{2} + \frac{5}{4}\frac{\rho}{k}, 1 - 2\sigma + \frac{\tau'}{4} + \frac{21}{8}\frac{\rho}{k}, \frac{1}{5}(8 - 16\sigma + 4\tau' + 9\frac{\rho}{k})).
\]
Applying \eqref{ze-bound5-rho-bound}, one obtains
\begin{align*}
3 - 4\sigma + \frac{\tau'}{2} + \frac{5}{4}\frac{\rho}{k} &\le \begin{cases}
(11 - 13\sigma)/2 + \tau'/2,& 1 \le \tau' < (19\sigma - 9)/5,\\
(31 - 45\sigma)/4 + 7\tau'/4,& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5\\
15/2 - 9\sigma + \tau'/2,& (9\sigma - 1)/5 \le \tau' < 6/5\\
6 - 9\sigma + 7\tau'/4,& 6/5 \le \tau' < 2\sigma - 2/5 + 2(1 - \sigma)/k\\
(5(1 - \sigma)/k + 11 - 13\sigma)/2 + \tau'/2,& 2\sigma - 2/5 + 2(1 - \sigma)/k \le \tau' \le (k + 1)/k
\end{cases}
\end{align*}
One may verify that the RHS is bounded by $\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'$ (with room to spare) by checking at the critical points $\tau' = 1$, $(9\sigma - 1)/5$ and $2\sigma - 2/5 + 2(1 - \sigma)/k$. Similarly, 
\[
1 - 2\sigma + \frac{\tau'}{4} + \frac{21}{8}\frac{\rho}{k} \le \begin{cases}
(25 - 29\sigma)/4 + \tau'/4,& 1 \le \tau' < (19\sigma - 9)/5,\\
(439 - 689\sigma)/40 + 23\tau'/8,& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5,\\
(209 - 250\sigma)/20 + \tau'/4,& (9\sigma - 1)/5 \le \tau' < 6/5,\\
(292 - 500\sigma)/40 + 23\tau'/8,& 6/5 \le \tau' < 2\sigma - 2/5 + 2(1 - \sigma)/k,\\
(21(1 - \sigma) + 25 - 29\sigma)/4 + \tau'/4,& 2\sigma - 2/5 + 2(1 - \sigma)/k \le \tau' \le (k + 1)/k.
\end{cases}
\]
One may verify that the RHS is bounded by $\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'$ (with room to spare). Lastly, 
\[
\frac{1}{5}(8 - 16\sigma + 4\tau' + 9\frac{\rho}{k}) \le \begin{cases}
2(13 - 17\sigma)/5 + 4\tau'/5,& 1 \le \tau' < (19\sigma - 9)/5,\\
(211 - 341\sigma)/25 + 13\tau'/5,& (19\sigma - 9)/5 \le \tau' < (9\sigma - 1)/5,\\
2(101 - 130\sigma)/25 + 4\tau'/5,& (9\sigma - 1)/5 \le \tau' < 6/5,\\
2(74 - 130\sigma)/25 + 13\tau'/5,& 6/5 \le \tau' < 2\sigma - 2/5 + 2(1 - \sigma)/k,\\
2(9(1 - \sigma)/k + 13 - 17\sigma)/5 + 4\tau'/5,& 2\sigma - 2/5 + 2(1 - \sigma)/k \le \tau' \le (k + 1)/k.
\end{cases}
\]
One may verify that the RHS is bounded by $\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'$ (with room to spare). Thus we have shown that 
\[
