...
6/5 < \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}, \frac{2(45 - 44\sigma)}{2\sigma + 15} < 2.
\end{equation}
...
\end{equation}
If $6/5 \le \tau' \le 2(\sigma - 1/5) + 2(1 - \sigma)/k$, then by \eqref{ze-bound2-rhok-bound}
\begin{equation}
\rho/k \le \frac{12}{5} - 4\sigma + \tau'.
\end{equation}
Substituting this into \eqref{ze-bound2-rho-star-bound}, one has (since $\sigma \le 3/4$ and $k \ge 2$)
\begin{align*}
...
On the other hand, if $2(\sigma - 1/5) + 2(1 - \sigma)/k \le \tau' \le 1 + 1/k$, then 
\[
