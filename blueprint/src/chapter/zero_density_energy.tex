...
\[
\A^*(\sigma) \le \min\left(\frac{5(18 - 19\sigma)}{2(5\sigma + 3)(1 - \sigma)}, \frac{2(45 - 44\sigma)}{(2\sigma + 15)(1 
- \sigma)}\right).
\]
\end{theorem}

\derived 
\code{prove_zero_density_energy_improved2()}

\begin{proof}

Throughout assume $7/10 \le \sigma \le 3/4$ and take $\tau_0 = 2$ in Corollary \ref{zeroe-large-cor-0}. It suffices to show that if $(\sigma, \tau, \rho, \rho^*, s) \in \Energy$ with $2 \le \tau \le 4$, then 
\begin{equation}
...
\frac{6}{5} < \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}, \frac{2(45 - 44\sigma)}{2\sigma + 15} < \frac{7}{4}.
\end{equation}
Next we record some useful results. Let 
\[
k := \begin{cases}
2,& 2 \le \tau < 3,\\
3,& 3 \le \tau \le 4,
...
\]
Via Theorem \ref{} and Lemma \ref{power-lemma}, one has 
\begin{equation}\label{ze-bound2-rho1}
\rho \le k\max(2 - 2\sigma, 1 - 2\sigma + \tau/k)
\end{equation}
and via Theorem \ref{} and Lemma \ref{power-lemma}, one has 
\[
\rho \le k\max(2 - 2\sigma, 18/5 - 4\sigma, 12/5 - 4\sigma + \tau/k)
\]
Since $\sigma \le 4/5$, we may drop the first term, i.e. 
\begin{equation}\label{ze-bound2-rho2}
\rho \le k\max(2 - 2\sigma, 12/5 - 4\sigma + \tau/k)
\end{equation}
...
\end{cases}
\end{equation}
One can verify that all intervals are proper for $7/10 \le \sigma \le 3/4$, $k = 2,3$. 

Since $(\sigma, \tau, \rho, \rho^*, s) \in \Energy$, by Theorem \eqref{hbt} one has  
\begin{equation}\label{ze-bound2-rhostar1}
\rho^* \leq 1-2\sigma + \frac{1}{2}\max(\rho+1, 2\rho, \frac{5}{4}\rho+\frac{\tau}{2}) + \frac{1}{2}\max(\rho^*+1, 4\rho, \frac{3}{4}\rho^*+\rho+\frac{\tau}{2}).
\end{equation}
Furthermore, by Lemma \ref{power-energy} $(\sigma, \tau/2, \rho', \rho^*/2, s') \in \Energy$ for some $\rho' \le \rho/2, s' \le s/2$. Applying Theorem \ref{hbt} and then the inequality $\rho' \le \rho/2$ one has 
\begin{equation}\label{ze-bound2-rhostar}
\frac{\rho^*}{2} \leq 1-2\sigma + \frac{1}{2}\max(\frac{\rho}{2}+1, \rho, \frac{5\rho}{8} + \frac{\tau}{4}) + \frac{1}{2}\max(\frac{\rho^*}{2}+1, 2\rho, \frac{3}{8}\rho^* +\frac{\rho}{2}+\frac{\tau}{4}).
\end{equation}
We now proceed to the main argument, which we divide into two cases.

\textbf{Case 1: $1 \le \tau' \le 6/5$:} 

Substituting $\tau' \le 6/5$ into \eqref{ze-bound2-rho1}, one has $\rho < 1$. If $\rho + 1 \ge 5\rho/4 + \tau'/2$ then by \eqref{ze-bound2-rhostar1}
\[
\rho^* \le \frac{3 - 4\sigma + \rho}{2} + \frac{1}{2}\max(\rho^* + 1, 4\rho, \frac{3}{4}\rho^*+\rho +\frac{\tau}{2}).
\]
Solving for $\rho^*$, we get 
\[
\rho^* \le \max(4 - 4\sigma + \rho, \frac{3 - 4\sigma + 5\rho}{2}, \frac{2}{5}(6 - 8\sigma + \tau + 4\rho))
\]
For $1 \le \tau' \le 13/5 - 2\sigma$, one has $\rho/k \le 1 - 2\sigma + \tau'$ and also one may verify that
\begin{align*}
\rho^*/k \le \max\Big(&\frac{4 - 4\sigma}{k} + 1 - 2\sigma + \tau', \frac{3 - 4\sigma + 5(1 - 2\sigma + \tau')}{2},\\
&\qquad \frac{2}{5}(6 - 8\sigma + k\tau' + 4(1 - 2\sigma + \tau'))\Big) \le \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'
\end{align*}
for $7/10 \le \sigma \le 3/4$ and $k = 2, 3$. Similarly, for $13/5 - 2\sigma \le \tau' \le 6/5$, one has $\rho/k \le 18/5 - 4\sigma$ and also one may verify that 
\begin{align*}
\rho^*/k \le \max\Big(&\frac{4 - 4\sigma}{k} + 18/5 - 4\sigma, \frac{3 - 4\sigma + 5(18/5 - 4\sigma)}{2},\\
&\qquad \frac{2}{5}(6 - 8\sigma + k\tau' + 4(18/5 - 4\sigma))\Big) \le \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'
\end{align*}
for $7/10 \le \sigma \le 3/4$ and $k = 2, 3$.

On the other hand, if $\rho + 1 < 5\rho/4 + \tau'/2$ then 
\[
\rho^* \le 1 - 2\sigma + \frac{5}{8}\rho + \frac{\tau}{4} + \frac{1}{2}\max(\rho^* + 1, 4\rho, \frac{3}{4}\rho^*+\rho +\frac{\tau}{2})
\]
Solving for $\rho$ gives 
...
For $1 \le \tau' \le 13/5 - 2\sigma$, one has $\rho/k \le 1 - 2\sigma + \tau'$ and also one may verify that
\begin{align*}
\rho^*/k \le \max\Big(&\frac{3 - 4\sigma}{k} + \frac{5}{4}(1 - 2\sigma) + \frac{7}{4}\tau', \frac{1 - 2\sigma}{k} + \frac{21}{8}(1 - 2\sigma) + \frac{23}{8}\tau',\\
&\qquad \frac{8(1 - 2\sigma)}{5k} + \frac{9}{5}(1 - 2\sigma) + \frac{13}{5}\tau'\Big)
\end{align*}
For $13/5 - 2\sigma \le \tau' \le 6/5$, one has $\rho/k \le 18/5 - 4\sigma$ and 
\begin{align*}
\rho^*/k \le \max\Big(&\frac{3 - 4\sigma}{k} + \frac{\tau'}{2} + \frac{5}{4}(\frac{18}{5} - 4\sigma), \frac{1 - 2\sigma}{k} + \frac{\tau'}{4} + \frac{21}{8}(\frac{18}{5} - 4\sigma),\\ &\qquad \frac{(8 - 16\sigma)/k + 4\tau' + 9(18/5 - 4\sigma)}{5}\Big)
\end{align*}
\textbf{TODO complete the argument}


\textbf{Case 2: $6/5 \le \tau' \le 1 + 1/k$:}

By Lemma \ref{power-energy}, $(\sigma, \tau', \rho', \rho^*/k, s') \in \Energy$ where $\rho' \le \rho/k$ and $s' \le s/k$. Therefore 
\[
\frac{\rho^*}{k} \le 1-2\sigma + \frac{1}{2}\max(\frac{\rho}{k}+1, \frac{2\rho}{k}, \frac{5\rho}{4k} + \frac{\tau'}{2}) + \frac{1}{2}\max(\frac{\rho^*}{k}+1, \frac{4\rho}{k}, \frac{3\rho^*}{4k} +\frac{\rho}{k}+\frac{\tau'}{2}).
\]
Note that \eqref{ze-bound2-rhok-bound} implies that $\rho/k \le 1$, so that the middle term in the first maximum may be removed. 
...
\rho^*/k \le \max(4 - 4\sigma + \frac{\rho}{k}, \frac{3 - 4\sigma + 5\rho/k}{2}, \frac{2}{5}(6 - 8\sigma + \tau' + \frac{4\rho}{k})).
\end{equation}
Recall that from \eqref{ze-bound2-rhok-bound} we have 
\begin{equation}\label{ze-bound2-rho-bound-temp}
\rho/k \le \begin{cases}
12/5 - 4\sigma + \tau',& 6/5 \le \tau' \le 2(\sigma - 1/5) + 2(1 - \sigma)/k\\
(2 - 2\sigma)(k + 1)/k,& 2(\sigma - 1/5) + 2(1 - \sigma)/k \le \tau' \le 1 + 1/k
\end{cases}
\end{equation}
Substituting the first case into \eqref{ze-bound2-rho-star-bound}, one has (since $\sigma \le 3/4$ and $k \ge 2$)
\begin{align*}
\rho^*/k \le \max(\frac{32}{5} - 8\sigma + \tau', \frac{15}{2} - 12\sigma + \frac{5}{2}\tau', \frac{156}{25} - \frac{48}{5}\sigma + 2\tau')
\end{align*}
By \eqref{ze-bound2-tau-factor-bounds}, we may check that the RHS is majorized by 
\[
\max\left(\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}, \frac{2(45 - 44\sigma)}{2\sigma + 15}\right)\tau'
\]
for all $6/5 \le \tau' \le 2(\sigma - 1/5) + 2(1-\sigma)/k$ by verifying that
\begin{equation}
\frac{32}{5} - 8\sigma + \tau' \le \max\left(\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}, \frac{2(45 - 44\sigma)}{2\sigma + 15}\right)\tau'
\end{equation}
holds at the lower limit $\tau' = 6/5$, and
\[
\max\left(\frac{15}{2} - 12\sigma + \frac{5}{2}\tau', \frac{156}{25} - \frac{48}{5}\sigma + 2\tau'\right) \le \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'
\]
holds at the upper limit $\tau' = 2(\sigma - 1/5) + 2(1 - \sigma)/k$ for $k = 2,3$. 

Substituting the second case of \eqref{ze-bound2-rho-bound-temp} into \eqref{ze-bound2-rho-star-bound}
\[
\frac{\rho}{k} \le (2 - 2\sigma)\frac{k + 1}{k}.
\]
Substituting into \eqref{ze-bound2-rho-star-bound}, one obtains 
\begin{align*}
\rho^*/k &\le \max(4 - 4\sigma + (2 - 2\sigma)\frac{k + 1}{k}, \frac{3 - 4\sigma}{2} + (5 - 5\sigma)\frac{k + 1}{k}, \\
&\qquad\qquad\frac{2}{5}(6 - 8\sigma + \tau' + (8 - 8\sigma)\frac{k + 1}{k}))\\
&\le \max\left(\frac{5(18 - 19\sigma)}{2(5\sigma + 3)}, \frac{2(45 - 44\sigma)}{2\sigma + 15}\right)\tau'
\end{align*}
where the last inequality follows since the LHS is increasing slower in $\tau$ than the RHS, and one may verify (after a tedious calculation) that the inequality holds at the lower-limit $\tau' = 2(\sigma - 1/5) + 2(1 - \sigma)/k$ for $k = 2, 3$.

On the other hand if $\rho/k  + 1 < 5\rho/(4k) + \tau'/2$, then 
\[
\rho^*/k \leq 1-2\sigma + \frac{5\rho}{8k} + \frac{\tau'}{4} + \frac{1}{2}\max(\frac{\rho^*}{k}+1, \frac{4\rho}{k}, \frac{3}{4}\frac{\rho^*}{k} + \frac{\rho}{k}+\frac{\tau'}{2})
\]
Solving for $\rho^*/k$ gives 
...
\rho^*/k \le \max(3 - 4\sigma + \frac{\tau'}{2} + \frac{5}{4}\frac{\rho}{k}, 1 - 2\sigma + \frac{\tau'}{4} + \frac{21}{8}\frac{\rho}{k}, \frac{1}{5}(8 - 16\sigma + 4\tau' + 9\frac{\rho}{k}))
\]
As before, if $6/5 \le \tau' \le 2(\sigma - 1/5) + 2(1-\sigma)/k$ then 
\[
\rho/k \le 12/5 - 4\sigma + \tau'
\]
so that 
\[
\rho^*/k \le \max(6 - 9\sigma + \frac{7}{4}\tau', \frac{73}{10} - \frac{25}{2}\sigma + \frac{23}{8}\tau', \frac{148 - 260\sigma + 65\tau'}{25}) \le \frac{5(18 - 19\sigma)}{2(5\sigma + 3)}\tau'
\]
where the last inequality follows from \eqref{ze-bound2-tau-factor-bounds} and since the inequality holds at the upper limit $\tau = 2(\sigma - 1/5) + 2(1-\sigma)/k$. If $2(\sigma - 1/5) + 2(1-\sigma)/k \le \tau' \le 1 + 1/k$ then 
\[
\rho/k \le (2 - 2\sigma)\frac{k + 1}{k}
\]
so that 
\begin{align*}
...
\end{align*}
where the last inequality holds in light of \eqref{ze-bound2-tau-factor-bounds} and verifying the inequality holds at the lower limit $\tau = 2(\sigma - 1/5) + 2(1-\sigma)/k$.
\end{proof}

\begin{theorem}\label{imp-energy-bound3}
For $3/4 \le \sigma \le 289/380$, one has 
\[
\A^*(\sigma) \le \frac{197 - 220\sigma}{8(5\sigma - 1)(1 - \sigma)}.
\]
\end{theorem}
...
For $3/4 \le \sigma \le 5/6$, one has 
\[
\A^*(\sigma) \le \frac{3(29 - 30\sigma)}{5(5\sigma - 1)(1 - \sigma)}.
\]
\end{theorem}
\begin{table}[ht]
    \def\arraystretch{2}
    ...
    \hline
    $\dfrac{3(29 - 30\sigma)}{5(5\sigma - 1)(1 - \sigma)}$ & $\dfrac{289}{380} \leq \sigma \le \dfrac{101 + \sqrt{1741}}{180} = 0.7929\ldots$ & Theorem \ref{imp-energy-bound4}\\
    \hline
    $\dfrac{40 - 36\sigma}{(20\sigma - 5)(1 - \sigma)}$ & $\dfrac{101 + \sqrt{1741}}{180} \leq \sigma \le \dfrac{5}{6} = 0.8333\ldots$ & Theorem \ref{imp-hb-energy-bound}\\
    \hline
