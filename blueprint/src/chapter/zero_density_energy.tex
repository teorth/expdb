...
\end{equation}
and since $\sigma \le 4/5$, by Theorem \ref{} one has 
...
\rho^*/k \le \frac{1151 - 1190\sigma}{20(15\sigma - 2)(1-\sigma)}\tau',\qquad (6/5 \le \tau' \le \tau_1(k + 1)/k).
\end{equation}
...
\end{split}
\end{equation}
For $\tau' \le 6/5$ by \eqref{ze-13-rho3} one has $\rho/k \le 18/5 - 4\sigma$, while for $\tau' \ge \tau_1$ by \eqref{ze-13-rho1} one has $\rho/k \le 50/13 - 76\sigma/13 + \tau'$. Therefore, for $\tau_1 \le \tau' \le 6/5$ one has $\rho/k \le \min(50/13 - 76\sigma/13 + \tau', 18/5-4\sigma)$. Substituting this bound into each case of \eqref{ze-13-rhostar-3}, one may verify that 
\[
\frac{\rho^*}{k} \le \frac{1151 - 1190\sigma}{20(15\sigma - 2)}\tau',\qquad (\tau_1 \le \tau' \le 6/5),
\]
