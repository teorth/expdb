...
\begin{proof}
Throughout assume that $3/4 \le \sigma \le 289/380$ and take $\tau_0 := 8\sigma - 4$ in Corollary \ref{zeroe-large-cor-0}. It suffices to show that 
\begin{equation}\label{ze-bound3-energy-req}
\rho^* \le \frac{197 - 220\sigma}{8(5\sigma - 1)}\tau\quad \text{for all}\quad (\sigma, \tau, \rho, \rho^*, s) \in \Energy, \quad\text{and}\quad \tau_0 \le \tau \le 2\tau_0
\end{equation}
and 
\begin{equation}\label{ze-bound3-energyzeta-req}
\rho^* \le \frac{197 - 220\sigma}{8(5\sigma - 1)}\tau\quad \text{for all}\quad (\sigma, \tau, \rho, \rho^*, s) \in \Energy_\zeta, \quad\text{and}\quad 2 \le \tau \le \tau_0.
\end{equation}
In the proof of Theorem \ref{imp-hb-energy-bound} we have already shown that if $(\sigma, \tau, \rho, \rho^*, s) \in \Energy_\zeta$ with $2 \le \tau \le 8\sigma - 4$, then 
\[
\rho^*/\tau \le \begin{cases}
\dfrac{45 - 46\sigma}{4(4\sigma - 1)},& 3/4 \le \sigma< 65/86,\\
\dfrac{4(10 - 9\sigma)}{5(4\sigma - 1)},&65/86 \le \sigma \le 5/6.
\end{cases}
\]
However, one may verify that the RHS is bounded by $(197 - 220\sigma)/(8(5\sigma - 1))$ for all $3/4 \le \sigma \le 289/380$ so that \eqref{ze-bound3-energyzeta-req} follows. 

Now consider \eqref{ze-bound3-energy-req}. Given $\sigma, \tau$, let $k \ge 2$ be the integer for which 
\[
k \le \frac{\tau}{4\sigma - 2} < k + 1
\]
and as before write $\tau' := \tau/k$. 
...
\end{cases}
\]
and from Theorem \ref{huxley-lv} and Lemma \ref{power-lemma}, one has 
\[
\rho/k \le \max(2 -2\sigma, 4 - 6\sigma + \tau') = \begin{cases}
2 - 2\sigma,&\tau' \le 4\sigma - 2,\\
4 - 6\sigma + \tau',& \tau' > 4\sigma - 2.
\end{cases}
\]
...
(2 - 2\sigma)(k + 1)/k,& \sigma + 3/5 \le \tau' \le (4\sigma - 2)(k + 1)/k.
\end{cases}
\end{equation}
...
\]
Applying $\rho/k \le \min(12/5 - 4\sigma + \tau', (2 - 2\sigma)(k + 1)/k)$, one ultimately obtains 
\[
...
\rho^*/k \le \max(3 - 4\sigma + \frac{\tau'}{2} + \frac{5}{4}\frac{\rho}{k}, 1 - 2\sigma + \frac{\tau'}{4} + \frac{21}{8}\frac{\rho}{k}, \frac{1}{5}(8 - 16\sigma + 4\tau' + 9\frac{\rho}{k})).
\]
Once again applying $\rho/k \le \min(12/5 - 4\sigma + \tau', (2 - 2\sigma)(k + 1)/k)$, one ultimately obtains 
\[
\rho^*/k \le \frac{197 - 220\sigma}{8(5\sigma - 1)}\tau'.
\]
...
\]
However, using $\rho/k \le \min(4 - 6\sigma + \tau', 18/5 - 4\sigma)$, one ultimately obtains 
\[
\rho^*/k \le \frac{197 - 220\sigma}{8(5\sigma - 1)}\tau'.
\]
...
For $3/4 \le \sigma \le 5/6$, one has 
\[
\A^*(\sigma) \le \max\left(\frac{3(29 - 30\sigma)}{5(5\sigma - 1)(1 - \sigma)}, \frac{4(10 - 9\sigma)}{5(4\sigma - 1)(1 - \sigma)}\right).
\]
\end{theorem}
