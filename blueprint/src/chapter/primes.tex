...
\begin{conjecture}[Prime gap conjecture]\uses{pnt-ap} $\PNTALL = 0$, and hence (by Lemma \ref{pnt-triv}) $\PNTAA = \GAPMAX=0$ and $\GAPSQUARE=1$.
\end{conjecture}
...
\begin{proposition}[Zero density theorems and prime gaps]\label{prime-gap}\uses{pnt-ap,zero-def}  Let
...
\begin{theorem}[Baker-Harman-Pintz theorem]\label{bhp-thm}\cite{baker-harman-pintz}\uses{pnt-ap} We have $\GAPMAX \leq 0.525$.
\end{theorem}
...
\begin{corollary}\label{primesquare-bounds}\uses{pnt-ap}\
    \begin{itemize}
