...
A typical result concerning $M(\sigma_0,A,\geq h)$ is as follows.

\begin{lemma}\label{ivic-6-large}\cite[(8.56)]{ivic}\uses{mixed-moment-def} $M(1/2, 6, \geq 11/72) \leq 1$.
\end{lemma}
