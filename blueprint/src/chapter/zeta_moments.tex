...
\begin{corollary}\label{moment_from_lindelof}\uses{zeta-moment-def, zeta-moment-basic,LH} If the Lindelof hypothesis holds, then $M(\sigma,A) = \max(1/2-\sigma,0) A$ for all $\sigma \in \R$ and $A \geq 0$.
\end{corollary}
