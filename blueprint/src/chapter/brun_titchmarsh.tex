...
\begin{table}[ht]
    ...
    $(0.523,0.524]$ \\
    $(0.524,0.535]$ \\
    \end{tabular} & \begin{tabular}{@{}c@{}} $2.7626$ \\
    $2.6484$ \\
    $2.5630$ \\
    $2.4597$ \\
    $2.3759$ \\
...
\begin{table}[ht]
    ...
    \hline
    Heath-Brown (1990) \cite{HeathBrownSiegel1990} & \begin{tabular}{@{}c@{}} $3 + \eps$ (if the exceptional zero does exist, effective) \\
    $2 + \eps$ (if the exceptional zero does exist, ineffective)
    \end{tabular} \\
    \hline
