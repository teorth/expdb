...
Averaged versions of the Brun--Titchmarsh inequality were proven in \cite{baker-harman-1996}.
...
\begin{table}[ht]
    ...
    \hline
    Li (2025) \cite{li_number_2025} & $0.52$ & $2.7614$\\
    \hline
    \end{tabular}
\label{bt-ctheta'-table}
\end{table}
...
Upper bounds on $\pi(x+x^\theta) - \pi(x)$ can be found in \cite{iwaniec_1982},
