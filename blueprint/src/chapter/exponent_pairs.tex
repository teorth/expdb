...
\begin{conjecture}[Exponent pairs conjecture]\label{exp-pair-conj}\uses{exp-pair-def}  $(0,1/2)$ is an exponent pair.  (Equivalently, by Corollary \ref{exp-pair-closed}, every point in the triangle \eqref{exp-pair-triangle} is an exponent pair.)
\end{conjecture}
...
\begin{theorem}[Exponent pairs from the Bombieri--Iwaniec method]\uses{exp-pair-def}  The following pairs are exponent pairs:
\begin{itemize}
...
\begin{theorem}[Exponent pairs from derivative tests]\uses{exp-pair-def} $(k,1-mk)$ is an exponent pair when
    \begin{itemize}
...
\begin{theorem}[Huxley sequence]\cite[Table 17.3]{huxley_area_1996}\uses{exp-pair-def}  For any integer $m \geq 1$, the pair
...
\begin{theorem}[1996 Heath--Brown sequence]\cite[(6.17.4)]{titchmarsh_theory_1986}\uses{exp-pair-def}  For any integer $m \geq 3$, the pair
...
\begin{theorem}[2017 Heath--Brown sequence]\cite[Theorem 2]{heathbrown_new_2017}\uses{exp-pair-def}
...
\begin{theorem}[Sargos $C$-process]\cite[Theorem 5]{sargos_analog_2003}\uses{exp-pair-def}  If $(k,\ell)$ is an exponent pair, then so is
