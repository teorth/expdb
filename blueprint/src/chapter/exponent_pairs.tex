...
\begin{conjecture}[Exponent pairs conjecture]\label{exp-pair-conj}  $(0,1/2)$ is an exponent pair.  (Equivalently, by Corollary \ref{exp-pair-closed}, every point in the triangle \eqref{exp-pair-triangle} is an exponent pair.)
\end{conjecture}
...
\begin{proposition}[Classical van der Corput exponent pairs]\label{vdc-class} For any natural number $k \geq 2$,
...
\begin{theorem}[Exponent pairs on the line of symmetry]\label{line-sym} $(k,k+1/2)$ is an exponent pair for
\begin{itemize}
...
\begin{theorem}[Exponent pairs from the Bombieri--Iwaniec method]  The following pairs are exponent pairs:
\begin{itemize}
...
\begin{theorem}[Exponent pairs from derivative tests] $(k,1-mk)$ is an exponent pair when
    \begin{itemize}
...
\begin{theorem}[Huxley sequence]\cite[Table 17.3]{huxley_area_1996}  For any integer $m \geq 1$, the pair
...
\begin{theorem}[1996 Heath--Brown sequence]\cite[(6.17.4)]{titchmarsh_theory_1986}  For any integer $m \geq 3$, the pair
...
\begin{theorem}[2017 Heath--Brown sequence]\cite[Theorem 2]{heathbrown_new_2017}
...
\begin{theorem}[Sargos $C$-process]\cite[Theorem 5]{sargos_analog_2003}  If $(k,\ell)$ is an exponent pair, then so is
