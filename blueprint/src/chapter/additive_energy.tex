...
\begin{lemma}\label{double-zeta-from-exp-pair}\cite[Lemma 11.2]{ivic}\uses{lv-edef}  If $(k,\ell)$ is an exponent pair with $k>0$, and $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$, then
...
\begin{theorem}[Guth--Maynard large values theorem]\label{guth-maynard-lvt}\cite[Theorem~1.1]{guth-maynard} One has
...
\derived
\code{prove_guth_maynard_large_values_theorem()}
...
\begin{theorem}[Additional Guth--Maynard large values estimate]\label{guth-maynard-extra} For any $1/2 < \sigma < 1$, $\tau \geq 1$, and natural number $k$ one has
    \begin{equation}\label{general-tau}
        \LV(\sigma,\tau) \leq \max(2-2\sigma, 5-6\sigma, (4-6\sigma)\frac{k}{k+1} + \frac{k}{k+1} \tau, (5-6\sigma) \frac{4k}{4k+3} + \frac{2}{4k+3} \tau, 2-4\sigma + \frac{4}{3} \tau, 3-4\sigma+\frac{1}{2} \tau, \frac{9}{2}-7\sigma+\tau, \frac{72-112\sigma}{19} + \frac{18}{19} \tau).
    \end{equation}
If one specializes to the case $\sigma \geq 7/10$ and $1 \leq \tau \leq 6/5$, one then has
    \begin{equation}\label{second-bound} \LV(\sigma,\tau) \leq \max(2-2\sigma, 3-4\sigma+\tau/2, (4-6\sigma)\frac{k}{k+1} + \frac{k}{k+1} \tau, (5-6\sigma) \frac{4k}{4k+3} + \frac{2}{4k+3} \tau).
    \end{equation}
and also
\begin{equation}\label{third-bound}
     \LV(\sigma,\tau) \leq \max(2-2\sigma, 3-4\sigma+\tau/2, \frac{46-60\sigma}{5} + \frac{30\sigma-21}{5} \tau).
\end{equation}
\end{theorem}
...
\literature
\code{add_bourgain_large_values_estimate()}
