...
\begin{lemma}[Basic properties of additive energy]\label{add-energy}
\begin{itemize}
...
\begin{theorem}[Reflection principle]\cite[\S 11.5]{ivic} If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$ with $\sigma \geq 3/4$ and $\tau>1$, then for any integer $k \geq 1$, either $\rho \leq 2-2\sigma$, or there exists $0 < \alpha \leq k(\tau-1)$ and $(\sigma, \tau/\alpha, \rho/\alpha, \rho^*/\alpha, s'/\alpha) \in \Energy$ such that
...
\begin{lemma}[Heath-Brown bound on double sums]\label{hb-double}  If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$, then
...
\begin{theorem}[Heath-Brown relation]\label{hbt}\cite[(33)]{heathbrown_zero_1979} If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$, then one has
...
\begin{lemma}[Second Heath-Brown relation] If If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$ then
...
\begin{lemma}[Guth-Maynard relation]\label{gm-1}  If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$ then
...
\begin{lemma}[Third Guth-Maynard relation]\label{gm-3}  If $(\sigma,\tau,\rho,\rho^*) \in \Energy$ and $1 \leq \tau \leq 4/3$, then
