...
\begin{equation}\label{snw-def}
     S(N,W) := \sum_{t,t' \in W} |\sum_{n \in [N,2N]} n^{-i(t-t')}|^2.
\end{equation}
...
\begin{equation}\label{ttww}
     \sum_{t \in W, t' \in W'} |\sum_{n \in [N,2N]} a_n n^{-it}|^2 \leq S(N,W)^{1/2} S(N,W')^{1/2}.
\end{equation}
In particular
$$ \sum_{t \in W} |\sum_{n \in [N,2N]} a_n n^{-it}|^2 \leq S(N,W).$$
\end{lemma}
...
$$ s \leq \max( \rho+1, 5\rho/3 + \tau/3, \frac{2+3k+4\ell}{1+2k+2\ell} \rho + \frac{k+\ell}{1+2k+2\ell} \tau) + 1.$$
\end{lemma}
