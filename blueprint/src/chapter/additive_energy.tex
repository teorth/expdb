...
\begin{lemma}[Raising to a power]\label{power-energy}\uses{lv-edef}  If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$, then $(\sigma,\tau/k, \rho/k, (\rho^*)/k,s/k) \in \Energy$ for any integer $k \geq 1$.
\end{lemma}
...
\begin{lemma}[Second Guth-Maynard relation]\cite[Lemma 1.7]{guth-maynard}\uses{lv-edef}  If $(\sigma,\tau,\rho,\rho^*,s) \in \Energy$ then
...
\begin{theorem}[Guth--Maynard large values theorem, again]\label{guth-maynard-lvt-again}\uses{lv-def} One has
...
It was noted in \cite{guth-maynard} that some improvements are available in the $\tau < 6/5$ regime. For instance:

\begin{lemma}[Improved Guth--Maynard theorem]\label{guth-maynard-lvt-improv}\uses{lv-def} \cite[Proposition 12.1]{guth-maynard} If $1 \leq \tau \leq 6/5$ and $\sigma \geq 7/10$ then for any natural number $k$ one has
    $$ \LV(\sigma,\tau) \leq \max\left( 2-2\sigma, \frac{\tau}{2}+3-4\sigma, \max( \frac{k}{k+1}\tau + \frac{k}{k+1} (4-6\sigma), \frac{4k}{4k+3}(5-6\sigma) + \frac{2}{4k+3} \tau)\right).$$
In particular, one has
$$ \LV(\sigma,\tau) \leq \max\left( 2-2\sigma, \frac{\tau}{2}+3-4\sigma, \frac{30\sigma-21}{5} \tau + \frac{46-60\sigma}{5}\right).$$
\end{lemma}
