...
\input{chapter/zero_free_region.tex}
\input{chapter/prime_counting_function.tex}
\input{chapter/primes.tex}
\input{chapter/divisor_sum.tex}
\input{chapter/pythagorean_triples.tex}
\input{chapter/de_bruijn_newman.tex}
...
\input{chapter/brun_titchmarsh.tex}
\input{chapter/waring-goldbach-schnirelman.tex}
\input{chapter/gauss_circle.tex}

\input{chapter/zero_density_L_functions.tex}
